...
#         self.m[1][0] = xaxis.y;
#         self.m[2][0] = xaxis.z;
#         self.m[3][0] = -xaxis.dot_product(eye);
#         self.m[0][1] = yaxis.x;
#         self.m[1][1] = yaxis.y;
#         self.m[2][1] = yaxis.z;
#         self.m[3][1] = -yaxis.dot_product(eye);
#         self.m[0][2] = zaxis.x;
#         self.m[1][2] = zaxis.y;
#         self.m[2][2] = zaxis.z;
#         self.m[3][2] = -zaxis.dot_product(eye);
#         self.m[3][3] = 1
#
...
#
#     def __repr__(self):
#         return 'v:' + str(self.v) + 'step:' + str(self.step) + 'x:' + str(self.x) + 'y:' + str(self.y) + 'w:' + str(
#             self.w)
#
#
# class trapezoid:
